...
# Number of orthologues = 187 ortholog TFs
# 8 stages

setwd("~/Dropbox/02-OweniaGenome/06-Revision/00-DATA/17-Metazoan_comparative_transcriptomics_TF_only/Quantile_transformation")
...
setwd("~/Dropbox/02-OweniaGenome/06-Revision/00-DATA/17-Metazoan_comparative_transcriptomics_TF_only/one2one")
...
setwd("~/Dropbox/02-OweniaGenome/06-Revision/00-DATA/17-Metazoan_comparative_transcriptomics_TF_only/order")
...
setwd("~/Dropbox/02-OweniaGenome/06-Revision/00-DATA/17-Metazoan_comparative_transcriptomics_TF_only/Results")
...
# Number of orthologues = 230 ortholog TFs
# 14 stages
...
# Number of orthologues = 327 ortholog TFs
# 35 stages
...
# Number of orthologues = 270 ortholog TFs
# 14 stages
...
# Number of orthologues = 110 ortholog TFs
# 7 stages
...
# Number of orthologues = 210 ortholog TFs
# 18 stages
...
# Number of orthologues = 135 ortholog TFs
# 13 stages
...
# Number of orthologues = 336 ortholog TFs
# 14 stages
...
# Number of orthologues = 104 ortholog TFs
# 9 stages
...
# Number of orthologues = 155 ortholog TFs
# 9 stages
...
# 11. Re-import data from bootstrapped JSDs, normalise, and plot comparable data

setwd("~/Dropbox/02-OweniaGenome/06-Revision/00-DATA/17-Metazoan_comparative_transcriptomics_TF_only/Results")
Ofus_orthologues <- c(187,230,327,270,110,210,135,336,104,155)
...
allvalues_divid <- rbind(Ofus2Nvec_mean_divided,Ofus2Spur_mean_divided,
                         Ofus2Cgig_mean_divided,Ofus2Blan_mean_divided,
                         Ofus2Drer_mean_divided,Ofus2Dmel_mean_divided,
                         Ofus2Cele_mean_divided,Ofus2Ctel_mean_divided,
                         Ofus2Aque_mean_divided,Ofus2Chem_mean_divided)
...
pheatmap(Ofus2Ctel_final_normalised, 
         ...
         labels_row = c("64 cells","gastrula","stage 4tt larva","stage 5 larva",
...
pheatmap(Ofus2Cgig_final_normalised, 
         ...
         labels_col = c("blastula","gastrula","elongation","early larva",
                        "mitraria larva","competent larva","juvenile"),
         labels_row = c("early morula","morula","blastula","rotary movement","free-swimming",
...
pheatmap(Ofus2Cele_final_normalised, 
         ...
         labels_col = c("blastula","gastrula","elongation","early larva",
                        "mitraria larva","competent larva","juvenile"),
         labels_row = c("0-90 mpf","120-180 mpf", "210-240 mpf", "270-330 mpf",
...
pheatmap(Ofus2Dmel_final_normalised, 
         ...
         labels_col = c("blastula","gastrula","elongation","early larva",
                        "mitraria larva","competent larva","juvenile"),
         labels_row = c("0-2 hpf","2-4 hpf","4-8 hpf","8-12 hpf","12-16 hpf","16-20 hpf",
...
pheatmap(Ofus2Drer_final_normalised, 
         ...
         labels_col = c("blastula","gastrula","elongation","early larva",
                        "mitraria larva","competent larva","juvenile"),
         labels_row = c("2 hpf", "1,000 cells", "Dome", "Shield", "6 hpf", "8 hpf",
...
pheatmap(Ofus2Blan_final_normalised, 
         ...
         labels_col = c("blastula","gastrula","elongation","early larva",
                        "mitraria larva","competent larva","juvenile"),
         labels_row = c("blastula","7 hpf","8 hpf","10 hpf","11 hpf","15 hpf","18 hpf",
...
pheatmap(Ofus2Spur_final_normalised, 
         ...
         labels_col = c("blastula","gastrula","elongation","early larva",
                        "mitraria larva","competent larva","juvenile"),
         labels_row = c("hatched blastula","mesenchyme blastula","early gastrula","mid gastrula",
...
pheatmap(Ofus2Nvec_final_normalised, 
         ...
         labels_col = c("blastula","gastrula","elongation","early larva",
                        "mitraria larva","competent larva","juvenile"),
         labels_row = c("24 hpf","48 hpf","72 hpf","96 hpf","120 hpf","144 hpf","168 hpf","192 hpf"))
...
pheatmap(Ofus2Chem_final_normalised, 
         ...
         labels_col = c("blastula","gastrula","elongation","early larva",
                        "mitraria larva","competent larva","juvenile"),
         labels_row = c("early gastrula", "planula 24 hpf", "planula 48 hpf", "planula 72 hpf",
...
pheatmap(Ofus2Aque_final_normalised, 
         ...
         labels_col = c("blastula","gastrula","elongation","early larva",
                        "mitraria larva","competent larva","juvenile"),
         labels_row = c("cleavage","brown 24 hpf", "spot 48 hpf", "ring 72 hpf",
